...
data class IptvConfigurationProperties(
    ...
    val metadataEnhancementEnabled: Boolean = true, // Enable metadata enhancement (file size extraction from media files)
    val ffprobeEnabled: Boolean = true, // Enable FFprobe for resolution and codec extraction (requires metadataEnhancementEnabled=true)
