...
data class IptvConfigurationProperties(
    ...
    val liveCreateVfsEntries: Boolean = true, // Create VFS entries under /live during sync (default: true, can be disabled for cleanup)
    val liveLogVfsPaths: Boolean = false, // Log /live paths that would be created when IPTV_LIVE_CREATE_VFS_ENTRIES=true (default: false)
